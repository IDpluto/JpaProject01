...
public interface StudentService {
  ...
  public Student getStudent(int id) throws ResourceNotFoundExeption; // 학생 정보가 없을 경우 'ResourceNotFoundExeption' 예외 발생

  //(4) 학생정보 삭제 (Delete)
  // 주어진 ID에 해당하는 학생의 정보를 삭제하는 메서드
  public void deleteStudent(int id) throws ResourceNotFoundExeption; // 학생 정보가 없을 경우 'ResourceNotFoundExeption' 예외 발생
